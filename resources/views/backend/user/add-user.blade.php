                  ...
                  <div class="form-row">
                    ...
                    <font style="color: red;">
                     ...
                     <div class="form-group col-md-4">
                      ...
                      <input id="password2" type="password" class="form-control @error('password2') is-invalid @enderror" name="password2" value="{{ old('password2') }}"autocomplete="password2" autofocus>
                    <font style="color: red;">
