            ...
            <div class="card">
              <div class="card-header">
                <h3> Credit  Customers List
                  <a href="{{route('customers.credit.pdf')}}" class="btn btn-success float-right btn-sm" target="_blank"><i class="fa fa-download btn-sm"></i>Download Pdf</a>
                </h3>
              </div><!-- /.card-header -->
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <a title="Edit" href="{{route('customers.edit.invoice', $payment->invoice_id)}}" class="btn btn-sm btn-primary"><i class="fa fa-edit"></i></a>
